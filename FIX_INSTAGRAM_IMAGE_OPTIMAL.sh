...
echo "🔧 Instagram Rasm Yuklash - Eng Optimal Variant"
echo "================================================"
echo ""
...
echo "✅ Tugadi!"
echo ""
echo "🔧 Eng Optimal Variant:"
echo "   ✨ --write-thumbnail + --skip-download metod qo'shildi (eng ishonchli)"
echo "   ✨ Format selector'siz urinish (yt-dlp o'zi tanlaydi)"
echo "   ✨ 'No video formats' xatosi uchun maxsus boshqaruv"
echo "   ✨ Ko'proq fallback metodlar"
echo ""
echo "📝 Qanday ishlaydi:"
echo "   1. Thumbnail metod (--write-thumbnail + --skip-download)"
echo "   2. Format selector'siz urinish (yt-dlp o'zi tanlaydi)"
echo "   3. Agar 'No video formats' xatosi bo'lsa, explicit image format"
echo "   4. Minimal metod (oxirgi variant)"
echo ""
echo "🧪 Test qiling:"
