...
echo "🔧 /start Command'ni To'g'ridan-to'g'ri Yuborish"
echo "================================================"
echo ""
...
echo "   ✨ Til tanlash endi to'g'ridan-to'g'ri yuboriladi (queue orqali emas)"
echo "   ✨ Tezroq javob (queue kutish yo'q)"
echo "   ✨ Cache xatolari handle qilinadi"
echo "   ✨ Batafsil logging qo'shildi"
echo ""
echo "🧪 Test qiling:"
echo "   Botga /start yuboring"
echo "   Til tanlash tugmalari darhol ko'rinishi kerak"
echo "   Loglarni kuzatib turing:"
echo "   tail -f storage/logs/laravel.log | grep -E 'start|language|Handling'"
echo ""
