...
echo "🔧 Qaysi kanalga a'zo bo'lmaganini ko'rsatish..."
echo ""
...
echo "   ✨ Endi xabarda aynan qaysi kanalga a'zo bo'lmaganini ko'rsatadi"
echo "   ✨ Masalan: '❌ Hali quyidagi kanallarga a'zo bo'lmadingiz: @TheUzSoft'"
echo ""
echo "📱 Test qiling:"
echo "   1. Botga /start yuboring"
echo "   2. Tilni tanlang"
echo "   3. Kanalga a'zo bo'ling (yoki bo'lmang)"
echo "   4. '✅ Tekshirish' tugmasini bosing"
echo "   5. Agar a'zo bo'lmasangiz, qaysi kanalga a'zo bo'lmaganingiz ko'rinadi"
echo ""
