...
echo "🔧 HTML teglarni ko'rinib qolish muammosini tuzatish..."
echo ""
...
echo "   ✨ sendPhoto() - parse_mode='HTML' qo'shildi"
echo "   ✨ sendVideo() - parse_mode='HTML' qo'shildi"
echo "   ✨ sendMediaGroup() - parse_mode='HTML' qo'shildi"
echo ""
echo "📝 Endi caption'larda HTML teglar to'g'ri ko'rinadi:"
echo "   ✅ <b>Muvaffaqiyatli yuklandi!</b> - ko'rinib qolmaydi"
echo "   ✅ ⚡️ Tez va barqaror bot - to'g'ri formatda"
echo ""
