...
echo "🔧 /start buyrug'i tartibini tuzatish..."
echo ""
...
echo ""
echo "📝 Yangi tartib:"
echo "   1. /start → Darhol til tanlash ko'rinadi"
echo "   2. Til tanlash → Kanal a'zoligini tekshirish"
echo "   3. Agar a'zo bo'lsa → Welcome xabar"
echo "   4. Agar a'zo bo'lmasa → Subscription xabari"
echo ""
echo "📱 Test qiling:"
echo "   1. Botga /start yuboring"
echo "   2. Tilni tanlang"
echo "   3. Kanal a'zoligini tekshirish xabari ko'rinishi kerak (agar a'zo bo'lmasangiz)"
echo ""
